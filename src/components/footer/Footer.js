      ...
      >
        ...
        <div className="flex justify-around space-x-32">
          <div className="flex flex-col space-y-3 text-white">
            <a href="a.com" className="hover:text-brightRed">Home</a>
            <a href="a.com" className="hover:text-brightRed">Pricing</a>
            <a href="a.com" className="hover:text-brightRed">Products</a>
            <a href="a.com" className="hover:text-brightRed">About</a>
          </div>
          <div className="flex flex-col space-y-3 text-white">
            <a href="a.com" className="hover:text-brightRed">Careers</a>
            <a href="a.com" className="hover:text-brightRed">Community</a>
            <a href="a.com" className="hover:text-brightRed">Privacy Policy</a>
          </div>
        </div>
